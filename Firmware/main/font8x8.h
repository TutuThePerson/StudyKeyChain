...
// 8x8 monospaced bitmap font, ASCII 0x20 (space) to 0x7E (~)
// Each character is 8 bytes; each byte represents one column of 8 vertical pixels.
// Bit 0 (LSB) = top pixel, bit 7 (MSB) = bottom pixel.
// Public domain font (CP437 derivative).
